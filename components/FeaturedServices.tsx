        ...
        <section className="w-full py-12 md:py-20 lg:py-28 px-5 md:px-12 relative overflow-hidden" style={{ background: '#fefcf8' }}>
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10 lg:gap-16">
                ...
                <div className="md:w-2/5 flex flex-col justify-center">
                    ...
                    <p className="lux-body mb-10 max-w-sm text-justify md:text-left hyphens-auto md:hyphens-none">
    ...
    return (
        <div className="clay-card p-6 flex flex-col justify-between" style={{ minHeight: '190px' }}>
            ...
            <div>
                ...
                <p className="lux-body mb-3 text-justify md:text-left hyphens-auto md:hyphens-none" style={{ fontSize: 'clamp(13px, 3.5vw, 15px)', lineHeight: 1.6 }}>{svc.desc}</p>
